...
/**
 * Tipagem de um lembrete configurado pelo usuario.
 */
...
/**
 * Todos os dias da semana selecionados por padrao
 * nos lembretes pre-configurados.
 */
const ALL_DAYS = ["seg", "ter", "qua", "qui", "sex", "sab", "dom"];

/**
 * Lembretes pre-configurados exibidos por padrao.
 */
const defaultReminders: ReminderConfigEntry[] = [
  {
    ...
    time: "14:30",
    frequency: { customDays: ALL_DAYS },
    active: true,
  },
  {
    id: "2",
    label: "Faca uma pausa",
    time: "15:00",
    frequency: { customDays: ALL_DAYS },
    active: true,
  },
